...
export const COMMON_PHRASES: WubiPhraseData[] = [
  ...
  { word: '荷花', pinyin: 'hé huā', code86: 'ASAW', code98: 'ASAW', codeNew: 'ASAW', breakdown: '荷(AS) + 花(AW)' },
  { word: '快速', pinyin: 'kuài sù', code86: 'NNGK', code98: 'NNGK', codeNew: 'NNGK', breakdown: '快(NN) + 速(GK)' },

  // 三字词（1+1+2规则）
  { word: '计算机', pinyin: 'jì suàn jī', code86: 'YTSM', code98: 'YTSM', codeNew: 'YTSM', breakdown: '计(Y) + 算(T) + 机(SM)' },
  { word: '输入法', pinyin: 'shū rù fǎ', code86: 'LWIF', code98: 'LWIF', codeNew: 'LWIF', breakdown: '输(L) + 入(W) + 法(IF)' },
  { word: '科学技术', pinyin: 'kē xué jì shù', code86: 'TIRF', code98: 'TIRF', codeNew: 'TIRF', breakdown: '科(T) + 学(I) + 技(R) + 术(F)' },
  { word: '互联网', pinyin: 'hù lián wǎng', code86: 'GELM', code98: 'GELM', codeNew: 'GELM', breakdown: '互(G) + 联(E) + 网(LM)' },
  ...
  { word: '自强不息', pinyin: 'zì qiáng bù xī', code86: 'TXGT', code98: 'TXGT', codeNew: 'TXGT', breakdown: '自(T) + 强(X) + 不(G) + 息(T)' },
  { word: '春暖花开', pinyin: 'chūn nuǎn huā kāi', code86: 'DJAJ', code98: 'DJAJ', codeNew: 'DJAJ', breakdown: '春(D) + 暖(J) + 花(A) + 开(G)' },
  ...
  { word: '厚德载物', pinyin: 'hòu dé zài wù', code86: 'DTTT', code98: 'DTTT', codeNew: 'DTTT', breakdown: '厚(D) + 德(T) + 载(F) + 物(T)' },

  // 多字长词（1+1+1+末1规则）
  { word: '中华人民共和国', pinyin: 'zhōng huá rén mín gòng hé guó', code86: 'KWWL', code98: 'KWWL', codeNew: 'KWWL', breakdown: '中(K) + 华(W) + 人(W) + ... + 国(L)' },
  { word: '中国特色社会主义', pinyin: 'zhōng guó tè sè shè huì zhǔ yì', code86: 'KLPY', code98: 'KLPY', codeNew: 'KLPY', breakdown: '中(K) + 国(L) + 特(T) + ... + 义(Y)' }
];
